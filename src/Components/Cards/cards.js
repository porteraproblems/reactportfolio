            ...
            <CardDeck>
                ...
                <Card className="bg-dark text-light">
                    <Card.Body className="body">
                        ...
                        <Card.Link className="cardLink" target="_blank" rel="noreferrer" href="https://porteraproblems.github.io/QuizTime/">Take a look</Card.Link>
                        <br></br>
                        <Card.Link className="cardLink" target="_blank" rel="noreferrer" href="https://github.com/porteraproblems/QuizTime">Check the Code</Card.Link>
                    </Card.Body>
                </Card>
            </CardDeck>
        </div>
