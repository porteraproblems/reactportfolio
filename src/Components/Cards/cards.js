            ...
            <CardDeck>
                <Card className="bg-dark text-light">
                    ...
                    <Card.Body className="body">
                        ...
                        <Card.Link className="cardLink" target="_blank" href="https://rzelazny.github.io/Look4wardToIt/">Take a look</Card.Link>
                        <br></br>
                        <Card.Link className="cardLink" target="_blank" href="https://github.com/rzelazny/Look4wardToIt">Check the Code</Card.Link>
                    </Card.Body>
                </Card>
                <br></br>
                <Card className="bg-dark text-light">
                    <Card.Body className="body">
                        ...
                        <Card.Link className="cardLink" target="_blank" href="https://social-underground-2.herokuapp.com/signup">Take a look</Card.Link>
                        <br></br>
                        <Card.Link className="cardLink" target="_blank" href="https://github.com/rzelazny/social-underground-2">Check the Code</Card.Link>
                    </Card.Body>
                </Card>
                <br></br>
                <Card className="bg-dark text-light">
                    <Card.Body className="body">
                        ...
                        <Card.Link className="cardLink" target="_blank" href="https://porteraproblems.github.io/QuizTime/">Take a look</Card.Link>
                        <br></br>
                        <Card.Link className="cardLink" target="_blank" href="https://github.com/porteraproblems/QuizTime">Check the Code</Card.Link>
                    </Card.Body>
                </Card>
            </CardDeck>
        </div>
